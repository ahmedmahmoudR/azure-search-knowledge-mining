...
function CreateSearchIndex
{
        ...
        CallSearchAPI -url ("/datasources/"+$dataSourceName+"?api-version=2023-11-01") -body $dataSourceBody
        ...
        CallSearchAPI -url ("/skillsets/"+$skillsetName+"?api-version=2023-11-01") -body $skillBody
        ...
        CallSearchAPI -url ("/indexes/"+$indexName+"?api-version=2023-11-01") -body $indexBody
        ...
        CallSearchAPI -url ("/indexers/"+$indexerName+"?api-version=2023-11-01") -body $indexerBody
	}
